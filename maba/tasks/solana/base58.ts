...
assert(homeDirectory != undefined, 'process.env.HOME or process.env.USERPROFILE needs to be defined')

const defaultKeypairFile = path.resolve(homeDirectory, '.config/solana/id.json')
